  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (result.success) {
        ...
        navigate(`/feedback?email=${encodeURIComponent(formData.email)}&type=mentor`);
      } else {
      ...
      <div className="max-w-2xl mx-auto">
        ...
        <Card>
          <CardHeader className="text-center">
            <CardTitle className="text-2xl font-bold">Mentor Application</CardTitle>
            <CardDescription>
              Join our mentorship program and help guide the next generation of legal professionals
            </CardDescription>
          </CardHeader>
          <CardContent>
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div className="space-y-2">
                ...
                <Select onValueChange={(value) => handleInputChange("class_year", value)} required>
                  <SelectTrigger>
              ...
              <div className="space-y-2">
                <Label htmlFor="co_mentor_preference">Co-Mentor Preference</Label>
                <Textarea
                  id="co_mentor_preference"
                  value={formData.co_mentor_preference}
                  onChange={(e) => handleInputChange("co_mentor_preference", e.target.value)}
                  placeholder="Any preferences for working with a co-mentor?"
                />
              </div>
